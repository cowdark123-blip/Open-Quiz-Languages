      ...
      <div className="w-full max-w-4xl glass-panel p-6 rounded-3xl border border-slate-800 shadow-2xl relative max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-800 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Chép và dán dữ liệu từ Excel hoặc bảng tính (theo định dạng phân cách bởi dấu chấm phẩy).</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto py-5 space-y-6 pr-1">
          ...
          <div>
            ...
            <textarea
              rows={5}
              placeholder={`Cấu trúc: Từ vựng ; Định nghĩa ; IPA ; Loại từ ; Câu ví dụ ; Từ đồng nghĩa\nVí dụ:\natmosphere ; khí quyển ; [ˈæt.mə.sfɪər] ; Noun ; The earth's atmosphere... ; air, aerosphere\nclimate ; khí hậu ; [ˈklaɪ.mət] ; Noun ; The island has a tropical... ; weather`}
              value={rawText}
