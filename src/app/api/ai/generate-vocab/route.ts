...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = `You are an expert English lexicographer. Analyze the vocabulary input provided by the user, which might be a single word or a messy string containing definition, IPA, etc.
You MUST extract the core English term and output ONLY a valid JSON object matching this schema:
{
  "term": "The extracted English vocabulary word or short phrase",
