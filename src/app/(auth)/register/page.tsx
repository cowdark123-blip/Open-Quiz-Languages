    ...
    <div className="min-h-screen bg-[#090d16] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl border border-slate-800 shadow-2xl relative z-10 space-y-6">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-black text-white">Đăng Ký Tài Khoản OpenQuiz</h2>
          <p className="text-slate-400 text-xs mt-1">
            Đăng ký tức thì qua tài khoản Google hoặc GitHub
          </p>
        </div>
        ...
        <div className="space-y-3 pt-2">
          ...
          >
            ...
            <span>{loadingProvider === 'google' ? 'Đang kết nối Google...' : 'Đăng ký bằng Google'}</span>
          </button>
          ...
          >
            ...
            <span>{loadingProvider === 'github' ? 'Đang kết nối GitHub...' : 'Đăng ký bằng GitHub'}</span>
          </button>
        </div>
