...
import { Brain, AlertCircle, ShieldCheck, Loader2, Sparkles } from 'lucide-react'
      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-white font-outfit tracking-tight">
            Tạo Tài Khoản OpenQuiz AI
          </h2>
          <p className="text-slate-400 text-xs leading-relaxed max-w-xs">
            Bắt đầu trải nghiệm học tập từ vựng ngắt quãng SM-2 và AI luyện phát âm ngay
          </p>
        </div>
        ...
        <div className="space-y-3 pt-2">
          ...
          >
            ...
            <span>{loadingProvider === 'google' ? 'Đang kết nối Google...' : 'Đăng ký nhanh với Google'}</span>
          </motion.button>
          ...
          >
            ...
            <span>{loadingProvider === 'github' ? 'Đang kết nối GitHub...' : 'Đăng ký nhanh với GitHub'}</span>
          </motion.button>
        </div>
        ...
        <div className="pt-2 text-center border-t border-slate-800/80">
          <p className="text-xs text-slate-400">
            Đã có tài khoản?{' '}
            <Link href="/login" className="font-bold text-purple-400 hover:text-purple-300 underline ml-1">
              Đăng nhập ngay
            </Link>
          </p>
        </div>
